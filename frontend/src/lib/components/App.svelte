  ...
  <div class="container p-4">
    <nav class="grid grid-cols-2">
      <div
        ...
        class="flex items-center gap-4 font-bold text-2xl bg-linear-to-r from-purple-300 to-purple-950 bg-clip-text text-transparent [&_svg]:h-7 [&_svg]:w-7 [&_svg]:fill-purple-500"
      >
        Agata Khurtsidze
